...
//     htmlDivElement.appendChild(newDiv);
//
//     const name_surname_age=document.createElement('h3');
//     name_surname_age.innerText=`${simpson.name} - ${simpson.surname} - ${simpson.age}`;
//     newDiv.appendChild(name_surname_age);
//
...
//
// //
// for (const coursesKey of coursesArray) {
//
...
//     title.innerText=`${coursesKey.title}`;
//
//     const paragraph=document.createElement('p');
//     paragraph.style.border='2px solid red';
//     paragraph.style.marginTop='20px';
//     paragraph.innerText=`${coursesKey.monthDuration}`;
//
//     const paragraph1=document.createElement('p');
//     paragraph1.style.border='2px solid red';
//     paragraph1.style.marginTop='20px';
//     paragraph1.innerText=`${coursesKey.hourDuration}`;
//
//     const ul=document.createElement('div');
//     ul.style.border='2px solid red';
//
//     innerDiv.append(title, paragraph, paragraph1, ul);
//
//     const ul1=document.createElement('ul');
//     ul.appendChild(ul1);
//
//     for (const ul1Element of coursesKey.modules) {
//         const li=document.createElement('li');
//         li.innerText=`${ul1Element}`;
//         ul1.appendChild(li);
//     }
// }
